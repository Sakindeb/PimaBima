  ...
  <div class="main-content-wrapper">
    <div class="header-nav-left">
      <a class="logo-wrapper" href="index.html">
        <img src="https://freesvg.org/img/heartbeatw.png" alt="PimaBima-logos_transparent" />
      </a>

      

        
          <div class="header-nav-item nav-item-with-children">
            Home
          ...
          <a class="header-nav-item" href="https://www.acorns.com/banking/" data-track-id="redesignedHeaderSpend">
            Solutions
          ...
          <a class="header-nav-item" href="https://www.acorns.com/earn" data-track-id="redesignedHeaderEarn">
          ...
          <a class="header-nav-item" href="https://www.acorns.com/learn/" data-track-id="">
            Packages
            <div class="hover-bottom-border"></div>
          </a>
          ...
          <a class="header-nav-item" href="https://www.acorns.com/pricing" data-track-id="redesignedHeaderPricing">
            About us
            <div class="hover-bottom-border"></div>
          </a>
